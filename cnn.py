# Все это уже было в Machine-learning курсе, поэтому просто копирую сюда
...
# Home work
# Part 3 - Making new predictions (only for two picutres)
import numpy as np
from keras.preprocessing import image
test_image = image.load_img(
  'dataset/single_prediction/cat_or_dog_1.jpg', # путь _1 or _2
  target_size = (64, 64) # размер изображения такойже как и в сети CNN
) # получили один массив 64 х 64 , нам нужно три массива
# теперь нужно поулчить 64 х 64 х 3 , три разных массива со своими цветами
test_image = image.img_to_array(test_image) # получаем три массива 64 х 64
# разширяем массив до 4D, чтобы .predict выполнить
